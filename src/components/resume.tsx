    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      <header className="p-6 bg-primary text-primary-foreground">
        <div className="container mx-auto">
          <h1 className="text-3xl font-bold">GyeongHo Kim</h1>
          <p className="text-xl">I Build Web Experience, Full Stack</p>
          <div className="flex flex-col sm:flex-row items-start sm:items-center mt-2 space-y-2 sm:space-y-0 sm:space-x-4">
            ...
            >
              ...
              rlarudgh2017@gmail.com
            </a>
            <a href="tel:+821038125469" className="flex items-center">
                ...
                <Card>
                  ...
                  <CardContent>
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Design System & Storybook (Typography, Theme Color, Grid
                        System)
                      </li>
                      <li>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="mt-2">
                    ...
                    designer, two machine learning engineers, and one full-stack
                    developer.
                  </p>
                  <ul className="list-disc pl-5 mt-2 space-y-1">
                    <li>
                    ...
                    <li>
                      Assisted machine learning developers by building REST APIs
                      using Flask for their models.
                    </li>
                  </ul>
                </CardContent>
              </Card>
